                ...
                >
                  ...
                  {included && splitMode === "shares" && (
                    <input
                      ...
                      className="h-9 w-14 rounded-control border border-hairline-strong bg-surface px-2 text-center text-[14px] tabular-nums outline-none focus-visible:border-action focus-visible:ring-2 focus-visible:ring-action/30"
