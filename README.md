...
وب‌اپلیکیشن مدیریت مالی شخصی برای فارسی‌زبانان. کاربر هزینه‌هایش را با فرم، متن آزاد یا عکس فاکتور ثبت می‌کند، حساب‌های بانکی‌اش را تعریف می‌کند و هر خرج و درآمد را به حسابِ مربوطه می‌زند تا موجودی هر حساب خودش به‌روز بماند، می‌تواند پرینت حساب بانکی یک تا سه ماهه را آپلود کند تا فقط ردیف‌های ثبت‌نشده اضافه شوند، و داشبورد ماهانه‌ی درآمد/هزینه/مانده را می‌بیند.
